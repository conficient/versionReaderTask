...
describe('VersionReaderTask v3 tests', () => {
    ...
    it('Fails if no project spec is given (inputTest.ts)', (done: Mocha.Done) => {
    ...
    it('Runs if "searchPattern" is set (runVersion.ts)', function (done: Mocha.Done) {
    ...
    it('Variables and build values are set (runVersion.ts)', function (done: Mocha.Done) {
    ...
    it('Variables have Prefix applied if set (runVersionWithPrefix.ts)', function (done: Mocha.Done) {
