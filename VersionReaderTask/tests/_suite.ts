...
describe('VersionReaderTask v3 tests', () => {
    ...
    it('Fails if no project spec is given', function (done: Done) {
    ...
    it('Runs if "searchPattern" is set', function (done: Done) {
    ...
    it('Variables and build values are set', function (done: Done) {
    ...
    it('Variables have Prefix applied if set', function (done: Done) {
    ...
    it('Version reverts to 1.0.0 if not found', function (done: Done) {
        // reads the Version.csproj file with TEST prefix
